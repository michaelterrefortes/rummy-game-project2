...
public class Hand implements HandInterface{
   ...
   * @param object card to be added to the current hand.
   */
   ...
   */
   public Card [] findSet(Card [] cards)
    {

      if(this.getNumberOfCards() > 4 || this.getNumberOfCards() < 3) return null;

      Integer [] arr = new Integer[this.getNumberOfCards()];
      for(int i = 0; i < this.getNumberOfCards(); i++){
         arr[i] = (this.getCard(i).getRank()) - '0';
      }
   ...
   */
    ...
    */
    ...
    public Card play(int n, Card card){

         Card cardre = this.getCard(n);
         Card remcard = this.removeCard(cardre);
         return remcard;
